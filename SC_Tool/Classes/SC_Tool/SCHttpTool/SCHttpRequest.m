...
-(NSMutableDictionary *)params{
    ...
    //根据需求添加用户相关信息
    if ([SCUDUtil sharedInstance].islogin && self.needToken) {

        [_params setObject:@"04bd86708177778a9753201e7c4da7ef" forKey:@"oauth_token"];
        [_params setObject:@"13a12848ad0ff5db351f7c3a89842360" forKey:@"oauth_token_secret"];
        
//        if([SCUDUtil sharedInstance].oauth_token)
//            [_params setObject:[SCUDUtil sharedInstance].oauth_token forKey:@"oauth_token"];
//        
//        if([SCUDUtil sharedInstance].oauth_token_secret)
